    ...
    return Scaffold(
      appBar: AppBar(
          ...
          leading: IconButton(onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => chatBot(userNum: widget.UserNum))); // 마이페이지로 이동
                        ...
                        child: Container(
                          ...
                          child: OutlinedButton(
                              onPressed: (){
                                ...
                                //보류
                                //Navigator.of(context).push(MaterialPageRoute(builder: (context) => notice_records(userNum: widget.UserNum, noticeNum: chatbotnum,))); // 해당 채팅 내용으로 이동
                              },
                              child: Row(
                                children: [
                                  Expanded(
      ...
      bottomNavigationBar: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton( // 아이콘 버튼 위젯
                onPressed: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => chatBot(userNum: widget.UserNum,))); // 캘린더페이지로 화면 이동
                },
                icon: Icon(Icons.chat_outlined, color: Colors.blue),
              ),
              IconButton( // 아이콘 버튼 위젯
                onPressed: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => my_page(userNum: widget.UserNum))); // 마이페이지로 화면 이동
