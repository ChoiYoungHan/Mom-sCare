    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Image.asset(('edit.png'),color: Colors.grey,),
                      ), // 이미지 변경 필요
                    flex: 2,), //영역 2부여
                    Expanded(
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Image.asset(('edit.png'),color: Colors.black,),
                      ), // 이미지 변경 필요
                      flex: 2,), //영역 2부여
                    Expanded(
                      child: Container(),flex: 1, // 아이콘과 텍스트 사이 여백 1부여
          ...
          flex: 3,), // 버튼사이 간격 3부여
          Expanded(
            child: Container(),flex: 2, // 버튼사이 여백3 부여
          ),
          Expanded(
            child: Container(
              height: MediaQuery.of(context).size.width*0.1, // 위젯의 높이를 화면 너비*0.1로 설정
              width: MediaQuery.of(context).size.width*0.4,
              padding: EdgeInsets.fromLTRB(0, 20, 0, 20), // 상하10 여백을 줌
              child: OutlinedButton(
                onPressed: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => Edit())); // 설정 페이지로 이동
